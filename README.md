...
- For custom domain namespaces (e.g., `com.yourcompany.*`), you'll need to set up DNS authentication

### Automated Publishing with GitHub Actions

This project includes a GitHub Actions workflow (`.github/workflows/publish-mcp.yml`) that automatically publishes the MCP server when you create a new version tag.
...
- For custom domain namespaces, you'll need to set up DNS authentication as described in the [MCP documentation](https://github.com/modelcontextprotocol/registry/tree/main/docs/guides/publishing)
...
docker run -p 3000:3000 \
  ...
  -e BEE_FEED_PK="your_feed_private_key_here" \
  swarm-mcp
```
